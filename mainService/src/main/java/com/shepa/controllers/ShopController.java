...
public class ShopController {
    ...
    private ProductEurekaController productEurekaController;

    @Autowired
    public void setProductEurekaController(ProductEurekaController productEurekaController) {
        this.productEurekaController = productEurekaController;
    }
...
//        }
        ...
        List<Product> productsSource =  productEurekaController.getProducts();
